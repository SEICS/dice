...
def writeDice(query, attr_range, dataset, relation, gr="no"):
    dice = []
...
def evaluate_single_table(dataset, gr):
    if dataset == "census":
    ...
    for i in range(len(queries)): 
        ...
        writeDice(query=query, attr_range=attr_range, dataset=dataset, relation=relation, gr=gr)
